<%@ Page Title="" Language="C#" MasterPageFile="~/LuxuryShop.Master" AutoEventWireup="true" CodeBehind="06_shopping_cart.aspx.cs" Inherits="Project._06_shopping_cart" %>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="estimate-details shopping-cart-table" runat="server">
						<h4>Enter your destination to get a shipping estimate</h4>
						<form runat="server">
							<div class="form-group" runat="server">
								<select class="form-control minimal" runat="server">
							...
							<div class="form-group" runat="server">
								<input type="text" name="zip" class="form-control" placeholder="zip/postal-code" runat="server">
							</div>
							<input type="submit" value="get a quote" class="btn btn-default" runat="server"> 
						</form>
					</div>
				</div><!-- col-md-4 /- -->
				<!-- col-md-4 -->
				<div class="col-md-4 col-sm-6" runat="server">
					<!-- section-header -->
					<div class="section-header" runat="server">
						<h3>discount codes</h3>
					</div><!-- Section Header /- -->
					<div class="estimate-details shopping-cart-table coupon" runat="server">
						<h4>Enter your coupon code if you have</h4>
						<form>
							<div class="form-group">
								<input type="text" name="" class="form-control" placeholder="" runat="server">
								<input type="submit" value="apply" class="btn" runat="server">	
							</div>
						</form>
					</div>
				</div><!-- col-md-4 /- -->
				...
				<div class="col-md-4 col-sm-6" runat="server">
					<div class="estimate-details shopping-cart-table" runat="server">
						<table>
							<tbody>
								<tr class="cart-subtotal" runat="server">
									<th>Subtotal</th>
									<td><span class="amount" runat="server">&dollar;99.95</span></td>
								</tr>
								<tr class="order-total" runat="server">
									<th>Grand Total</th>
									<td><strong><span class="total-amount">99.95</span></strong> </td>
								</tr>
							</tbody>
						</table>
						<button type="submit" class="btn btn-default" runat="server">proceed to checkout</button>
					</div>
				</div><!-- col-md-4 /- -->
			</div>
		</div>
